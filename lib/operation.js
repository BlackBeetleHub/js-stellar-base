...
var Operation = exports.Operation = (function () {
    ...
    _createClass(Operation, null, {
        ...
        manageAlias: {
            value: function manageAlias(opts) {
                var attributes = {};

                attributes.aliasId = Keypair.fromPublicKey(opts.aliasId).xdrAccountId();
                attributes.isDelete = opts.isDelete;
                var manageAlias = new xdr.ManageAliasOp(attributes);
                var opAttributes = {};
                opAttributes.body = xdr.OperationBody.manageAlias(manageAlias);
                this.setSourceAccount(opAttributes, opts);
            ...
            value: function operationToObject(operation) {
                ...
                switch (operation.body()["switch"]().name) {
                    ...
                    case "inflation":
                        ...
                        break;
                    case "manageAlias":
                        result.type = "manageAlias";
                        result.aliasId = accountIdtoAddress(attrs.aliasId());
                        result.isDelete = attrs.isDelete();
                        break;
